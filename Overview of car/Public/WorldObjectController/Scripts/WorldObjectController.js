...
var initPos = script.getSceneObject().getTransform().getLocalPosition();
...
function setDefaultPos() {
    script.getSceneObject().getTransform().setLocalPosition(initPos);
    print(111);
}
...
script.api.getInitPos = getInitPos;
script.api.initialize = initialize;
script.api.setDefaultPos = setDefaultPos;